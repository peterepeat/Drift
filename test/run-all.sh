...
for suite in protocol interest grid checkpoint decouple growth seasons anomalies anomaly-fuse water-crystals stones water-flow thermal ceiling creature-world creature-social communion fish marks giant; do
  boot
  echo "=== $suite ==="
