...
for suite in protocol interest grid checkpoint decouple growth seasons anomalies water-crystals stones water-flow thermal ceiling creature-world creature-social communion fish marks; do
  boot
  echo "=== $suite ==="
