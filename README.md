...
Phases 1–3 are all shipped — the world exists, grows, turns through seasons, pools and flows water, warms and forms stone, stacks and erodes, stays bounded, and (if you ask it to) sounds. What remains is tuning by feel and hardening for very large scale (interest-managed initial payloads for a 10k-object world). And by design, forever: no accounts, no chat, no notifications, no sharing, no scores, no onboarding, no words in the world.
